        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="http://mail.<?php echo preg_replace('/^www\./','',$_SERVER['HTTP_HOST']); ?>">Webmail Pro</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-lg-offset-1 col-sm-push-6 col-sm-6 text-center">
                    ...
                    <a class="btn-2 btn-2a" href="http://mail.<?php echo preg_replace('/^www\./','',$_SERVER['HTTP_HOST']); ?>" role="button">Ir al Webmail Pro</a>
                </div>
