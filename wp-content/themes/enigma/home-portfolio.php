		...
		<div class="row" >
			<div id="enigma_portfolio_section" class="enima_photo_gallery">
				...
				<div class="col-sm-12">
					...
					<script type="text/javascript" src="https://dolar.wilkinsonpc.com.co/widgets/gratis/indicadores-economicos-max.js?ancho=300&alto=400&fondo=transparent&fsize=20&ffamily=sans-serif&fcolor=000000"></script>
					</div>
					<!-- DolarWeb IndMax End -->
				</div>
