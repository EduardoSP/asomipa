		...
		<div class="container" >
			...
			<?php } ?>
				...
				<ul class="head-contact-info">
					<li><i class="fa fa-map-marker aria-hidden=true"></i><a href="mailto:<?php echo ""; ?>"><?php echo "Carrera 43 No. 37-21 Barrio el Prado Palmira - Valle"; ?></a></li>
				...
				<?php } ?>
				<ul class="head-contact-info">
					<li data-original-title="" title=""><i class="fa fa-user"></i><a href="http://localhost/asomipa/login/">
					<?php 
					echo "f";
